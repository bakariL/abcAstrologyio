...
$birthday = date_format($date, 'M d, Y h:ia');

$subject = "ABC Astrology | Horoscope Reading";
$mailMessageAdmin = '
<html>
    <head>
    </head>
    <body style="font-family: sans-serif; text-align: center; background: #fff4e0">
        <div style="display: inline-block; padding: 20px; background: #fff; border-radius: 10px; margin-top: 40px;">
            ...
            <h3>Horoscope Reading Request</h3>
...
<html>
    ...
    <body style="font-family: sans-serif; text-align: center; background: #fff4e0; padding:40px 0px;">
        <div style="display: inline-block; padding: 20px; background: #fff; border-radius: 10px;">
            <a href="http://www.abcastrology.io"><img class="logo" src="http://www.abcastrology.io/wp-content/themes/abcastrology/assets/mail-logo.jpg" style="width: 160px"></a>
            <h1>Horoscope Reading Request</h1>
